...
(2, 'Malek', 'Johnston & Murphy', 'Contrast insets at the toe and sides bring updated attitude to a' ),
(3, 'Air Max 270 React', 'Nike', 'The reggae inspired Nike Air 270 React fuses forest green with sha' ),
(3, 'Joyride', 'Nike', 'Tiny foam beads underfoot conform to your foot for cushioning that stands up '),
(2, 'Air Force 1', 'Nike', 'A modern take on the icon that blends classic style and fresh, crisp det '),
(3, 'Ghost 12', 'Brooks', 'Just know that it still strikes a just-right balance of DNA LOFT softness' );
...
(12, 12, 'Light Brown', 'Coming Soon', 128.77), 
(2, 10, 'Gray', 'Coming Soon', 102.45), 
(10, 8, 'Green', 'Coming Soon', 186.86), 
(12, 8, 'Blue', 'Coming Soon', 139.73), 
...
(11, 9, 'Light Brown', 'Coming Soon', 119.61), 
(11, 10, 'Black', 'Coming Soon', 114.36), 
(7, 9, 'Light Brown', 'Coming Soon', 181.93), 
(5, 10, 'Black', 'Coming Soon', 108.32), 
(12, 12, 'Black', 'Coming Soon', 153.97), 
...
VALUES (24, 70, 2, 0.11, false, 0.0),
    ...
    (12, 94, 2, 0.1, false, 0.0),
    (49, 22, 2, 0.09, false, 0.0),
    (12, 55, 2, 0.1, false, 0.0),
